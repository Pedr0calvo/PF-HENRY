...
export const getOrderByUser = (payload) => {
  return async function (dispatch) {
    let json = await axios.get(
      "https://pf-henry-production.up.railway.app/payment/orden",
      {
        headers: { payload },
      }
    );
...
export const getPay = async (payload, user, adress) => {
  let asd = await axios.post(
    "https://pf-henry-production.up.railway.app/payment",
    {
      payload,
      user,
      adress,
  ...
  return async function (dispatch) {
    try {
      let json = await axios.post(
        "https://pf-henry-production.up.railway.app/artworks",
        {
          payload: payload,
          role: role,
        }
  ...
  return async function (dispatch) {
    ...
    try {
      let json = await axios.put(
        "https://pf-henry-production.up.railway.app/artworks/delete/" + id
      );
...
export function putArtwork(payload, role) {
  return async function (dispatch) {
    try {
      let json = await axios.put(
        "https://pf-henry-production.up.railway.app/artworks/" + payload.id,
        {
          payload: payload,
          role: role,
        }
...
export const RegisterUser = async (payload) => {
  try {
    let json = await axios.post(
      "https://pf-henry-production.up.railway.app/users",
      payload
    );
    swal({
      title: "Good job!",
...
export const getProductByName = (payload) => {
  return async function (dispatch) {
    try {
      let json = await axios.get(
        "https://pf-henry-production.up.railway.app/artworks?title=" + payload
      );
...
export const getProductById = (id) => {
  return async function (dispatch) {
    let json = await axios.get(
      "https://pf-henry-production.up.railway.app/artworks/" + id
    );
...
export const getArtists = () => {
  return async function (dispatch) {
    let json = await axios.get(
      "https://pf-henry-production.up.railway.app/artists"
    );
    return dispatch({
      type: GET_ARTISTS,
      payload: json.data,
...
export const deleteProductFromCarrito = async (payload) => {
  axios.post(
    `https://pf-henry-production.up.railway.app/cart/delete/${payload.artId}`,
    { email: payload.email }
  );
};
...
export const addProductToCarrito = async (payload) => {
  axios.post(
    `https://pf-henry-production.up.railway.app/cart/${payload.artId}`,
    {
      email: payload.email,
    }
  );
...
export const deleteProductFromFavourites = async (payload) => {
  axios.post(
    `https://pf-henry-production.up.railway.app/favourites/delete/${payload.artId}`,
    { email: payload.email }
  );
};
...
export const addProductToFavourites = async (payload) => {
  axios.post(
    `https://pf-henry-production.up.railway.app/favourites/${payload.artId}`,
    { email: payload.email }
  );
};
...
export const getFavourites = (payload) => {
  return async function (dispatch) {
    let json = await axios.get(
      "https://pf-henry-production.up.railway.app/favourites",
      {
        headers: {
          payload: payload,
        },
...
export const getUser = (data) => {
  return async function (dispatch) {
    let json = await axios.post(
      `https://pf-henry-production.up.railway.app/users/findorcreate`,
      data
    );
    return dispatch({
      type: GET_USER,
...
export const sendUserInfo = async ({
  ...
  await axios.post("https://pf-henry-production.up.railway.app/users", {
    name,
    lastname,
    email,
    password,
...
export async function deleteUser(userId, ban) {
  await axios.put(
    `https://pf-henry-production.up.railway.app/users/ban/${userId}`,
    {
      ban,
    }
  );
...
export const getProductsFromCarritoDB = (payload) => {
  return async function (dispatch) {
    let json = await axios.get(
      "https://pf-henry-production.up.railway.app/cart",
      {
        headers: {
          payload: payload,
        },
...
export const getBuyHistory = (payload) => {
  return async function (dispatch) {
    let json = await axios.get(
      "https://pf-henry-production.up.railway.app/history",
      {
        headers: {
          payload: payload,
        },
...
export const LogLocal = (payload) => {
  return async function (dispatch) {
    try {
      let json = await axios.post(
        `https://pf-henry-production.up.railway.app/users/findLocalUser`,
        payload
      );
      dispatch({
        type: LOG_LOCAL,
...
export const updateUser = (user) => {
  return async function () {
    await axios.put(
      `https://pf-henry-production.up.railway.app/users/update`,
      user
    );
  };
};
...
export const findUserById = (id) => {
  return async function (dispatch) {
    let json = await axios.get(
      `https://pf-henry-production.up.railway.app/users/${id}`
    );
    return dispatch({
...
export function sendEmail(a) {
  return async function (dispatch) {
    const email = await axios.post(
      "https://pf-henry-production.up.railway.app/sendemail",
      { email: a }
    );
    return dispatch({
      type: SEND_EMAIL,
...
export async function resetPassword(payload) {
  await axios.post(
    "https://pf-henry-production.up.railway.app/users/restorePassword",
    payload
  );
}
...
export const postAdress = async (payload, email) => {
  await axios.post("https://pf-henry-production.up.railway.app/adresses", {
    payload,
    email,
  });
};
...
export const putAdress = async (payload, email) => {
  await axios.put("https://pf-henry-production.up.railway.app/adresses", {
    payload,
    email,
  });
};
...
export const getAdress = async (email) => {
  const adress = await axios.get(
    "https://pf-henry-production.up.railway.app/adresses",
    { headers: { email } }
  );
  return adress;
};
